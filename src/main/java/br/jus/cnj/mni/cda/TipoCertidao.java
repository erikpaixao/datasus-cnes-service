 ...
 *       &lt;sequence&gt;
 *         &lt;element name="devedorPrincipal" type="{http://www.cnj.jus.br/mni/cda}tipoDevedorPrincipal" maxOccurs="unbounded" form="qualified"/&gt;
 *         &lt;element name="devedorAlternativo" type="{http://www.cnj.jus.br/mni/cda}tipoDevedorAlternativo" maxOccurs="unbounded" minOccurs="0" form="qualified"/&gt;
 *         &lt;element name="valor" type="{http://www.cnj.jus.br/mni/cda}valorDivida" maxOccurs="unbounded" form="qualified"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
