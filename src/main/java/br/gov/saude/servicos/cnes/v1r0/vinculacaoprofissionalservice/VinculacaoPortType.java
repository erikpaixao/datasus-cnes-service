...
/**
 * This class was generated by Apache CXF 3.1.10 2018-04-10T14:07:05.118-03:00
...
public interface VinculacaoPortType {
    ...
    public ResponseVinculacao detalharVinculacaoProfissionalSaude(
            @WebParam(partName = "RequestVinculacao", name = "RequestVinculacao", targetNamespace = "http://servicos.saude.gov.br/cnes/v1r0/vinculacaoprofissionalservice") RequestVinculacao requestVinculacao
    ...
    public ResponseVinculacaos pesquisarVinculacaoProfissionalSaude(
            @WebParam(partName = "RequestVinculacaos", name = "RequestVinculacaos", targetNamespace = "http://servicos.saude.gov.br/cnes/v1r0/vinculacaoprofissionalservice") RequestVinculacaos requestVinculacaos
    ) throws VinculacaoFault;
}
